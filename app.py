...
def diabetespredict():
    ...
    time_slot = request_data['timeslot']
    bus_crowd = request_data['Buscrowd']
    available_buses = request_data['availablebuses']
    type_of_bus = request_data['typeofbus']
    day_name = request_data['dayname']
    is_Weekday = request_data['isWeekday']
    day_type = request_data['daytype']
    is_holiday = request_data['isHoliday']
    trafic = request_data['trafic']
    available_bus_drivers = request_data['available_bus_drivers']
    weather = request_data['weather']
    route_condition = request_data['route_condition']
    busy_reason = request_data['busyreason']
